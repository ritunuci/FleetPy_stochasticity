...
class Demand:
    ...
    def record_no_show(self, rid, vid, op_id, simulation_time, pu_pos=None, t_access=None):
        ...
        """
        # self.rq_db[rid].user_no_show()
        LOG.debug(f"Traveler {rid} did not show up for veh {vid} and op {op_id} at time {simulation_time}")
        self.rq_db[rid].leave_system_time = simulation_time
