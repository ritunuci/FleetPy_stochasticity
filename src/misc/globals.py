...
G_SKIP_OUTPUT = "skip_output"   # RL-GYM: suppress every file write and the output-dir wipe -> default False
G_RL_MODE = "rl_mode"           # RL-GYM: simulation is driven by the gym environment -> default False
...
G_MORNING_HR_START = "morning_hr_start"
G_MORNING_HR_END = "morning_hr_end"
G_AFTERNOON_HR_START = "afternoon_hr_start"
G_AFTERNOON_HR_END = "afternoon_hr_end"
G_EVENING_HR_START = "evening_hr_start"
G_EVENING_HR_END = "evening_hr_end"
...
G_RQ_VID = "vehicle_id"
G_RQ_VID_CANCEL_RQ = "vehicle_id_cancelled_rq"
G_RQ_PU = "pickup_time"
...
G_RQ_INITIAL_EXPECTED_WAIT_TIME = "initial_expected_wait_time"    # Ritun added: To store the initially calculated expected wait time for a request (before starting the cancellation decision process)
G_RQ_EXPECTED_WAIT_TIME = "last_wait_time"
...
G_RQ_MAX_DIFF_DEC_TIME_REACHED = "max_diff_dec_time_reached"    # Ritun added for diffusion model
G_RQ_LAST_DIFFUSION_STATE_T = "last_diffusion_state_value"    # Ritun added for diffusion model
...
G_VR_LEG_EARLIEST_START_TIME = "earliest_start_time"    # Ritun added for earlist start time of a leg (including boarding stops)
# G_VR_LEG_LATEST_START_TIME = "latest_start_time"    # Ritun added for latest start time of a leg (including boarding stops. NOT WORKING)
...
G_VR_LEG_FIRST_ATTEMPT_TIME = "first_attempt_time"
G_VR_LEG_WAIT_DELAY = "no_show_wait_delay"
G_VR_LEG_NO_SHOW_EVENT_FOR_VEH = "no_show_event_log_for_veh"
